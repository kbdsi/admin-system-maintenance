...
class Province extends Component {
    ...
    handleSearchedImmediate(e) {
        //console.log(`yang lama ${this.state.provinceDemanded} yang ${e.target.value}`);
        this.setState({
    ...
    handleSearchedSubmited(e) {
        ...
        if (this.state.provinceDemanded.length === 0) {
            ...
            //saat tombol search ditekan, cari dari provinceData
    ...
    componentDidMount() {
        ...
        // fetch("https://kbdsi-mtsys.herokuapp.com/v0/province/retrieve-all")
                        ...
                        <div className="col-lg-12">
                                        ...
                                        <div className="row-highlight col-sm-12 bg-gray-100">
                                            <div className="col-md-6">
                                                <div className="form-group row">
                                                    ...
                                                    <label className="col-sm-1 col-form-label margin-top-rem-1">:</label>
                                                    <input className="col-sm-6 form-control margin-top-rem-1 label-bold" value={this.state.provinceDemanded} type={"text"} onChange={this.handleSearchedImmediate} />
                                                </div>
                                            </div>
                            ...
                            <div className=" pt-3 col-md-12 col-xl-12">
                                <TableTemplate
                                    ...
                                    addButtonShow={true}
                                    addButtonNav={"/provinceAdd"}
                                    linkToDetail={["/province", 1]}
                                />
                            </div>
