...
class District extends Component {
    ...
    handleSearchedImmediate(e) {
        //console.log(`yang lama ${this.state.districtDemanded} yang ${e.target.value}`);
        this.setState({
            districtDemanded: e.target.value,
        });
    }
    handleSearchedSubmited(e) {
        e.preventDefault();
        if (this.state.districtDemanded.length === 0) {
            var records = this.state.districtList;
            var recordsTem = [];
            var headersTem = [];
            headersTem.push("No.");
            ...
            //saat tombol search ditekan, cari dari districtData
            if (this.state.searchCriteria === "Code") {
                ...
                //var recordsTem=[];
                var records = this.state.districtList.filter((district) => district.code.toString().includes(this.state.districtDemanded.toUpperCase()));
                //console.log(records);
                var recordsTem = [];
                var headersTem = [];
                headersTem.push("No.");
                ...
                var records = this.state.districtList.filter((district) => district.name.toString().includes(this.state.districtDemanded.toUpperCase()));
                //console.log(records);
    ...
    componentDidUpdate(prevProps, prevState, snapShot) {
        //console.log(this.state.districtDemanded);
        /*if (this.state.showSearchResult === true && prevState.showSearchResult === false) {
          //tombol untuk mencari sudah ditekan sehingga dengan algoritma pencarian, masukkan setiap nama district yang sesuai ke TableTemplate
        } else */
    ...
    componentDidMount() {
        ...
        // fetch("https://kbdsi-mtsys.herokuapp.com/v0/district/retrieve-all")
        ...
        //get all district from mbak izza
        // axios
        //   .get("https://kbdsi-mtsys.herokuapp.com/v0/district/retrieve-all", {
        //     headers: {
        //       //Accept: "application/json",
        //       Accept: "application/json",
        //       // "Access-Control-Allow-Origin": "*",
                        ...
                        <div className="col-lg-12">
                                ...
                                <div className="card-body">
                                    <form className="row" onSubmit={this.handleSearchedSubmited}>
                                        ...
                                        <div className="row-highlight col-sm-12 bg-gray-200">
                                            <div className="col-md-6">
                                                <div className="form-group row">
                                                    <label htmlFor="inputdistrictSelect" className="col-sm-4 col-form-label margin-top-rem-1 label-bold label-mandatory">Country</label>
                                                    <label className="col-sm-1 col-form-label margin-top-rem-1">:</label>
                                        ...
                                        <div className="row-highlight col-sm-12 bg-gray-100">
                                            <div className="col-md-6">
                                                <div className="form-group row">
                                                    ...
                                                    <label className="col-sm-1 col-form-label margin-top-rem-1">:</label>
                                                    <input className="col-sm-6 form-control margin-top-rem-1 label-bold" value={this.state.districtDemanded} type={"text"} onChange={this.handleSearchedImmediate} />
                                                </div>
                                            </div>
                            ...
                            <div className=" pt-3 col-md-12 col-xl-12">
                                <TableTemplate
                                    ...
                                    addButtonShow={true}
                                    addButtonNav={"/district-create"}
                                    linkToDetail={["/district", 1]}
                                />
                            </div>
