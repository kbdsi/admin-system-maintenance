...
class DistrictUpdate extends Component {
    constructor(props) {
        super(props);
        this.state = {
            districtCode: this.props.params.id,
            districtEdited: {},
            nameNewdistrict: "",
            codeNewdistrict: "",
            descriptionNewdistrict: "",
            alternateNewdistrict: "",
        };
    ...
    handleSubmit(e) {
        e.preventDefault();
        if (this.state.alternateNewdistrict === "" || this.state.descriptionNewdistrict === "" || this.state.codeNewdistrict === "" || this.state.nameNewdistrict === "") {
            return;
        }
        let district = {
            name: this.state.nameNewdistrict,
            code: this.state.codeNewdistrict,
            description: this.state.descriptionNewdistrict,
            alternate_description: this.state.alternateNewdistrict,
            is_system: false,
            created_by: "USER",
        };
        ...
        this.setState({
            districtEdited: district,
        });
    }
    handleChangeDescription(e) {
        this.setState({
            descriptionNewdistrict: e.target.value,
        });
    }
    handleChangeName(e) {
        this.setState({
            nameNewdistrict: e.target.value,
        });
    }
    handleChangeCode(e) {
        this.setState({
            codeNewdistrict: e.target.value,
        });
    }
    handleChangeAlternate(e) {
        this.setState({
            alternateNewdistrict: e.target.value,
        });
    }
    componentDidUpdate() {
        //console.log(`name:${this.state.nameNewdistrict} , code:${this.state.codeNewdistrict},alternate_description:${this.state.alternateNewdistrict}, description:${this.state.descriptionNewdistrict}`);
    }
        ...
        fetch("/districtData.json")
            ...
            .then((result) => {
                ...
                for (let i = 0; i < result.length; i++) {
                    if (result[i].code === this.state.districtCode.toString()) {
                        let districtChosen = {
                            code: result[i].code,
                            name: result[i].name,
                        ...
                        this.setState({
                            codeNewdistrict: result[i].code,
                            nameNewdistrict: result[i].name,
                            descriptionNewdistrict: result[i].description,
                            alternateNewdistrict: alternateFinal,
                            districtEdited: districtChosen,
                        });
                        break;
                    }
                }
    ...
    render() {
        return (
            <>
                {this.state.districtEdited != null ? (
                    <div className="container-fluid">
                                            ...
                                            <div className="row gx-0 col-md-12 bg-ginger">
                                                <div className="col-md-6">
                                                    <div className="row gx-0 form-group flex-row h-100 align-items-center">
                                                        ...
                                                        <input required={true} onChange={this.handleChangeCode} value={this.state.codeNewdistrict} className="col-sm-6 form-control margin-top-rem-1 label-bold" />
                                                    </div>
                                                </div>
                                                <div className="col-md-6">
                                                    <div className="row h-100 gx-0 form-group flex-row align-items-center">
                                                        ...
                                                        <label className="col-sm-1 col-form-label">:</label>
                                                        <input required={true} value={this.state.nameNewdistrict} onChange={this.handleChangeName} className="col-sm-6 form-control margin-top-rem-1 label-bold" />
                                                    </div>
                                                </div>
                                            </div>
                                            <div className="row gx-0 col-md-12 bg-light">
                                                <div className="col-md-6">
                                                    <div className="form-group row gx-0 flex-row h-100 align-items-center">
                                                        ...
                                                        <label className="col-sm-1 col-form-label">:</label>
                                                        <input required={true} value={this.state.descriptionNewdistrict} onChange={this.handleChangeDescription} className="col-sm-6 form-control margin-top-rem-1 label-bold    " />
                                                    </div>
                                                </div>
                                                <div className="col-md-6">
                                                    <div className="form-group row gx-0 flex-row h-100 align-items-center">
                                                        ...
                                                        <label className="col-sm-1 col-form-label">:</label>
                                                        <input required={true} value={this.state.alternateNewdistrict} onChange={this.handleChangeAlternate} className="col-sm-7 col-lg-7 col-md-7 my-3 label" />
                                                    </div>
                                                </div>
                                            </div>
...
export default (props) => <DistrictUpdate {...props} params={useParams()} />;