...
//                     <h1 className="h3 mb-1 text-gray-800">INDONESIA &gt; DKI JAKARTA &gt; district</h1>
...
class DistrictDetail extends Component {
    //saat dipanggil, langsung render awal dengan district list yang kosong karena belum ada pencarian
    constructor(props) {
    ...
    } //saat setelah dirender, seorang dapat mencari district dengan mengetik dalam input text, nama / code district.
    componentDidUpdate(prevProps, prevState, snapShot) {
        //
        //console.log(this.state.districtChosen);
    }
    componentDidMount() {
                                            ...
                                            <div className="row gx-0 align-items-center col-md-12 bg-ginger">
                                                <div className="col-md-6">
                                                    <div className="form-group row gx-0">
                                                        ...
                                                        <label className="col-sm-7 col-form-label">{this.state.districtChosen.code == null ? "" : `${this.state.districtChosen.code}`}</label>
                                                    </div>
                                                </div>
                                                <div className="col-md-6">
                                                    <div className="form-group row gx-0">
                                                        ...
                                                        <label className="col-sm-1 col-form-label">:</label>
                                                        <label className="col-sm-7 col-form-label">{this.state.districtChosen.name == null ? "" : `${this.state.districtChosen.name}`}</label>
                                                    </div>
                                                </div>
                                            </div>
                                            <div className="row gx-0 col-md-12 bg-light align-items-center">
                                                <div className="col-md-6">
                                                    <div className="form-group row gx-0">
                                                        ...
                                                        <label className="col-sm-1 col-form-label">:</label>
                                                        <label className="col-sm-7 col-form-label">{this.state.districtChosen.description == null ? "" : `${this.state.districtChosen.description}`}</label>
                                                    </div>
                                                </div>
                                                <div className="col-md-6">
                                                    <div className="form-group row gx-0">
                                                        ...
                                                        <label className="col-sm-1 col-form-label ">:</label>
                                                        <label className="col-sm-7 col-form-label">{this.state.districtChosen.alternate_description == null ? "" : `${this.state.districtChosen.alternate_description}`}</label>
                                                    </div>
                                                </div>
                                            </div>
                                            <div className="row gx-0 col-md-12 bg-ginger align-items-center">
                                                <div className="col-md-6">
                                                    <div className="form-group row gx-0">
                                                        ...
                                                        <label className="col-sm-1 col-form-label">:</label>
                                                        <label className="col-sm-7 col-form-label">{this.state.districtChosen.default_value == null ? "" : `${this.state.districtChosen.default_value}`}</label>
                                                    </div>
                                                </div>
                                                <div className="col-md-6">
                                                    <div className="form-group row gx-0">
                                            ...
                                            <div className="row gx-0 align-items-center col-md-12 bg-light">
                                                <div className="col-md-6">
                                                    <div className="form-group gx-0 row">
                                                        ...
                                                        <label className="col-sm-1 col-form-label ">:</label>
                                                        <label className="col-sm-7 col-form-label ">{this.state.districtChosen.system == null ? "" : `${this.state.districtChosen.system}`}</label>
                                                    </div>
                                                </div>
                                                <div className="col-md-6">
                                                    <div className="form-group gx-0 row">
                                                        ...
                                                        <label className="col-sm-1 col-form-label">:</label>
                                                        <label className="col-sm-7 col-form-label">{this.state.districtChosen.deleted == null ? "" : `${this.state.districtChosen.deleted}`}</label>
                                                    </div>
                                                </div>
                                            </div>
                                            <div className="gx-0 row col-md-12 bg-ginger align-items-center">
                                                <div className="col-md-6">
                                                    <div className="form-group gx-0 row">
                                                        ...
                                                        <label className="col-sm-1 col-form-label ">:</label>
                                                        <label className="col-sm-7 col-form-label ">{this.state.districtChosen.approved == null ? "" : `${this.state.districtChosen.approved}`}</label>
                                                    </div>
                                                </div>
                                                <div className="col-md-6">
                                                    <div className="form-group gx-0 row">
                                            ...
                                            <div className="gx-0 row col-md-12 bg-light align-items-center">
                                                <div className="col-md-6">
                                                    <div className="form-group gx-0 row">
                                                        ...
                                                        <label className="col-sm-1 col-form-label">:</label>
                                                        <label className="col-sm-7 col-form-label">{this.state.districtChosen.approved_by == null ? "" : `${this.state.districtChosen.approved_by}`}</label>
                                                    </div>
                                                </div>
                                                <div className="col-md-6">
                                                    <div className="form-group gx-0 row">
                                                        ...
                                                        <label className="col-sm-1 col-form-label ">:</label>
                                                        <label className="col-sm-7 col-form-label ">{this.state.districtChosen.approved_date == null ? "" : `${this.state.districtChosen.approved_date}`}</label>
                                                    </div>
                                                </div>
                                            </div>
                                            <div className="row gx-0 col-md-12 bg-ginger align-items-center">
                                                <div className="col-md-6">
                                                    <div className="form-group gx-0 row">
                                                        ...
                                                        <label className="col-sm-1 col-form-label">:</label>
                                                        <label className="col-sm-7 col-form-label">{this.state.districtChosen.created_by == null ? "" : this.state.districtChosen.created_by}</label>
                                                    </div>
                                                </div>
                                                <div className="col-md-6">
                                                    <div className="form-group gx-0 row">
                                                        ...
                                                        <label className="col-sm-1 col-form-label">:</label>
                                                        <label className="col-sm-7 col-form-label">{this.state.districtChosen.created_date == null ? "" : `${this.state.districtChosen.created_date}`}</label>
                                                    </div>
                                                </div>
                                            </div>
                                            <div className="row gx-0 col-md-12 bg-light align-items-center">
                                                <div className="col-md-6">
                                                    <div className="form-group gx-0 row">
                                                        ...
                                                        <label className="col-sm-1 col-form-label">:</label>
                                                        <label className="col-sm-7 col-form-label">{this.state.districtChosen.created_ip_address == null ? "" : `${this.state.districtChosen.created_ip_address}`}</label>
                                                    </div>
                                                </div>
                                                <div className="col-md-6">
                                                    <div className="form-group gx-0 row">
                                            ...
                                            <div className="gx-0 row col-md-12 bg-ginger align-items-center">
                                                <div className="col-md-6">
                                                    <div className="form-group gx-0 row">
                                                        ...
                                                        <label className="col-sm-1 col-form-label">:</label>
                                                        <label className="col-sm-7 col-form-label">{this.state.districtChosen.updated_by == null ? "" : `${this.state.districtChosen.updated_by}`}</label>
                                                    </div>
                                                </div>
                                                <div className="col-md-6">
                                                    <div className="form-group gx-0 row">
                                                        ...
                                                        <label className="col-sm-1 col-form-label ">:</label>
                                                        <label className="col-sm-7 col-form-label ">{this.state.districtChosen.updated_date == null ? "" : `${this.state.districtChosen.updated_date}`}</label>
                                                    </div>
                                                </div>
                                            </div>
                                            <div className="gx-0 row col-md-12 bg-light align-items-center">
                                                <div className="col-md-6">
                                                    <div className="form-group gx-0 row">
                                                        ...
                                                        <label className="col-sm-1 col-form-label ">:</label>
                                                        <label className="col-sm-7 col-form-label ">{this.state.districtChosen.updated_ip_address == null ? "" : `${this.state.districtChosen.updated_ip_address}`}</label>
                                                    </div>
                                                </div>
                                                <div className="col-md-6">
                                                    <div className="form-group gx-0 row">
                                                        ...
                                                        <label className="col-sm-1 col-form-label ">:</label>
                                                        <label className="col-sm-7 col-form-label ">{this.state.districtChosen.updated_content_type == null ? "" : `${this.state.districtChosen.updated_content_type}`}</label>
                                                    </div>
                                                </div>
                                            </div>
                                            <div className="row gx-0 col-md-12 bg-ginger align-items-center">
                                                <div className="col-md-6">
                                                    <div className="form-group gx-0 row">
                                                        ...
                                                        <label className="col-sm-1 col-form-label ">:</label>
                                                        <label className="col-sm-7 col-form-label ">{this.state.districtChosen.version == null ? "" : `${this.state.districtChosen.version}`}</label>
                                                    </div>
                                                </div>
                                                {/* <div className="col-md-6">
                          <div className="form-group gx-0 row">
                            ...
                            <label className="col-sm-7 col-form-label"></label>
                                            ...
                                            <div className="flex-wrap d-flex flex-row justify-content-center col-sm-12 mt-2">
                                                ...
                                                <div className="btn-center mx-2">
                                                    <Link to={`/district/${this.state.idChosen}/edit`}>
                                                ...
                                                <div className="btn-center mx-2">
                                                    <Link to="/district" className="text-decoration-none">
...
export default (props) => <DistrictDetail {...props} params={useParams()} />;
