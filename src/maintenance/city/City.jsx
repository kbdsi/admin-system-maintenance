...
class City extends Component {
    ...
    handleSearchedImmediate(e) {
        //console.log(`yang lama ${this.state.cityDemanded} yang ${e.target.value}`);
        this.setState({
            cityDemanded: e.target.value,
        });
    }
    handleSearchedSubmited(e) {
        e.preventDefault();
        if (this.state.cityDemanded.length === 0) {
            var records = this.state.cityList;
            var recordsTem = [];
            var headersTem = [];
            headersTem.push("No.");
            ...
            //saat tombol search ditekan, cari dari cityData
            if (this.state.searchCriteria === "Code") {
                ...
                //var recordsTem=[];
                var records = this.state.cityList.filter((city) => city.code.toString().includes(this.state.cityDemanded.toUpperCase()));
                //console.log(records);
                var recordsTem = [];
                var headersTem = [];
                headersTem.push("No.");
                ...
                var records = this.state.cityList.filter((city) => city.name.toString().includes(this.state.cityDemanded.toUpperCase()));
                //console.log(records);
    ...
    componentDidUpdate(prevProps, prevState, snapShot) {
        //console.log(this.state.cityDemanded);
        /*if (this.state.showSearchResult === true && prevState.showSearchResult === false) {
          //tombol untuk mencari sudah ditekan sehingga dengan algoritma pencarian, masukkan setiap nama city yang sesuai ke TableTemplate
        } else */
    ...
    componentDidMount() {
        ...
        // fetch("https://kbdsi-mtsys.herokuapp.com/v0/city/retrieve-all")
        ...
        //get all city from mbak izza
        // axios
        //   .get("https://kbdsi-mtsys.herokuapp.com/v0/city/retrieve-all", {
        //     headers: {
        //       //Accept: "application/json",
        //       Accept: "application/json",
        //       // "Access-Control-Allow-Origin": "*",
                                ...
                                <div className="card-body">
                                    <form className="row" onSubmit={this.handleSearchedSubmited}>
                                        ...
                                        <div className="row-highlight col-sm-12 bg-gray-200">
                                            <div className="col-md-6">
                                                <div className="form-group row">
                                                    <label htmlFor="inputcitySelect" className="col-sm-4 col-form-label margin-top-rem-1 label-bold label-mandatory">Country</label>
                                                    <label className="col-sm-1 col-form-label margin-top-rem-1">:</label>
                                        ...
                                        <div className="row-highlight col-sm-12 bg-gray-100">
                                            <div className="col-md-6">
                                                <div className="form-group row">
                                                    ...
                                                    <label className="col-sm-1 col-form-label margin-top-rem-1">:</label>
                                                    <input className="col-sm-6 form-control margin-top-rem-1 label-bold" value={this.state.cityDemanded} type={"text"} onChange={this.handleSearchedImmediate} />
                                                </div>
                                            </div>
