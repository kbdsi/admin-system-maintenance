...
import EngFlag from "./public/img/flags/us.png"
                    ...
                    <ul className="navbar-nav navbar-align">
                        ...
                        <li className="nav-item dropdown">
                            ...
                            <a className="nav-link dropdown-toggle d-none d-sm-inline-block" href="#" data-bs-toggle="dropdown">
                                <img src={Profil} className="avatar img-fluid rounded me-1" alt="Charles Hall" /> <span className="text-dark">Charles Hall</span>
                            </a>
